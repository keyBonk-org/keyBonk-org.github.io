...
- **Yumo audio**：基于 Win32 的 C++17 音频库，目前只支持 WAV 播放，支持异步非阻塞播放、音频混合、暂停/静音和音量独立控制。
...
| **音频格式** | WAV | WAV | WAV / MP3 等 | PCM | 多种 | PCM | PCM | 12+ 种 | 几乎全部 | PCM | WAV/MP3/OGG/FLAC | 多种 |
| **异步播放** | ✅ | ✅（SND_ASYNC） | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| **适用场景** | 轻量级 WAV 多音效管理 | 简单提示音 | 简单媒体播放 | 底层音频控制 | 游戏/高性能音频 | 专业音频应用 | 3D 游戏音效 | 跨平台游戏 | 专业游戏音频 | 实时音频采集 | 轻量级游戏 | 极简嵌入式项目 |